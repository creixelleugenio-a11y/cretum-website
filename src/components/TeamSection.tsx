...
const operativo = [
  ...
  { id: "o8", nameKey: "team.o8.name", roleKey: "team.o8.role", bioKey: null, photo: "/team/o8.jpg" },
];
...
export function TeamSection() {
  ...
  return (
    <section id="nuestro-equipo" className="min-h-screen pt-56 pb-40 bg-background relative overflow-hidden">
