...
const directivos = [
  ...
  { id: "d2", nameKey: "team.d2.name", roleKey: "team.d2.role", bioKey: "team.d2.bio", photo: "/team/d2-v3.jpg" },
  { id: "o1", nameKey: "team.o1.name", roleKey: "team.o1.role", bioKey: "team.o1.bio", photo: "/team/o1-v3.jpg" },
];

const operativo = [
  { id: "o5", nameKey: "team.o5.name", roleKey: "team.o5.role", bioKey: null, photo: "/team/o5.jpg" },
  { id: "o4", nameKey: "team.o4.name", roleKey: "team.o4.role", bioKey: null, photo: "/team/o4-v3.jpg" },
  { id: "o7", nameKey: "team.o7.name", roleKey: "team.o7.role", bioKey: "team.o7.bio", photo: "/team/o7-v3.jpg" },
  { id: "d3", nameKey: "team.d3.name", roleKey: "team.d3.role", bioKey: "team.d3.bio", photo: "/team/d3.jpg" },
  { id: "o9", nameKey: "team.o9.name", roleKey: "team.o9.role", bioKey: null, photo: "" },
  { id: "o2", nameKey: "team.o2.name", roleKey: "team.o2.role", bioKey: null, photo: "/team/o2.jpg" },
  { id: "o6", nameKey: "team.o6.name", roleKey: "team.o6.role", bioKey: null, photo: "/team/o6-v3.jpg" },
  { id: "o3", nameKey: "team.o3.name", roleKey: "team.o3.role", bioKey: null, photo: "/team/o3.jpg" },
  { id: "o8", nameKey: "team.o8.name", roleKey: "team.o8.role", bioKey: null, photo: "/team/o8-v3.jpg" },
  { id: "o10", nameKey: "team.o10.name", roleKey: "team.o10.role", bioKey: null, photo: "/team/o10-v3.jpg" },
];
...
function MemberCard({ member, onClick }: { member: Member; onClick: () => void }) {
  ...
  return (
    <button
      onClick={onClick}
      className="group border border-border rounded-xl p-4 sm:p-5 md:p-6 hover:bg-muted/50 transition-all duration-300 cursor-pointer text-center active:scale-95 w-full h-full flex flex-col items-center justify-center"
    >
      <Avatar className="w-20 h-20 md:w-24 md:h-24 mx-auto mb-3 ring-2 ring-primary/20 group-hover:ring-primary/50 transition-all">
...
export function TeamSection() {
  ...
  return (
    <section id="nuestro-equipo" className="min-h-screen pt-16 sm:pt-32 md:pt-56 pb-16 md:pb-40 bg-background relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 w-full">
        <Reveal>
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif text-foreground mb-4">{t("team.title")}</h2>
        </Reveal>
        <Reveal delay={0.45}>
